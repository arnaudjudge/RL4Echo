...
class SimplePG(pl.LightningModule):
    ...
    def training_step(self, batch: Tuple[torch.Tensor, torch.Tensor], nb_batch) -> OrderedDict:
        ...
        loss, reward, actions = self.compute_policy_loss((b_img, actions, rewards, b_gt), sample=True)
    ...
    def validation_step(self, batch, batch_idx: int):
        ...
        # calculates training loss
        loss, reward, actions = self.compute_policy_loss((b_img, prev_actions, prev_rewards, b_gt), sample=True)
    ...
    def test_step(self, batch, batch_idx: int):
        ...
        # calculates training loss
        loss, reward, actions = self.compute_policy_loss((b_img, prev_actions, prev_rewards, b_gt), sample=False)
