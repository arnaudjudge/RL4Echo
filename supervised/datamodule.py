...
if __name__ == "__main__":
    ...
    dl = SectorDataModule('/home/local/USHERBROOKE/juda2901/dev/data/icardio/processed/', '/home/local/USHERBROOKE/juda2901/dev/data/icardio/processed/processed.csv')
    dl.setup()
    for i in range(1):
