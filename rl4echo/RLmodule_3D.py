...
from utils.logging_helper import log_image, log_sequence
...
class RLmodule3D(pl.LightningModule):
    ...
    def test_step(self, batch: dict[str, Tensor], batch_idx: int):
        ...
        for i in range(len(b_img)):
            ...
            log_sequence(self.logger, img=prev_actions[i].unsqueeze(0), title='test_Prediction', number=batch_idx * (i + 1),
